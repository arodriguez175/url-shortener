  ...
  render() {
    return (
      <div>
        ...
        <p>
          Set up the perfect custom domain for your brand—all within Shortly—in
          minutes.
        </p>
        ...
        <p>
          ...
          your choosing so you can take total control of your content. By using
          your brand in your links, your audience will know they can trust them.
        </p>
        ...
        <p>
          ...
          links and knows where they lead, they’re more likely to click on them.
        </p>
      </div>
    );
  }
