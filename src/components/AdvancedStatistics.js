  ...
  render() {
    return (
      <div className="advanced-statistics">
        ...
        <div className="advancedStatisticsBlock">
          ...
          <p className="advancedStatisticsBlockTitle">Brand Recognition</p>
          <p className="advancedStatisticsInfo">
            Boost your brand recognition with each click. Generic links don't
            mean a thing. Branded links help instill confidence in your content.
          </p>
        </div>

        <div className="advancedStatisticsBlock" id="statisticsBlock2">
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40">
            <path
              fill="#2BD0D0"
          ...
          <p className="advancedStatisticsBlockTitle">Detailed Records</p>
          <p className="advancedStatisticsInfo">
        ...
        <div className="advancedStatisticsBlock" id="statisticsBlock3">
          ...
          <p className="advancedStatisticsBlockTitle">Fully Customizable</p>
          <p className="advancedStatisticsInfo">
